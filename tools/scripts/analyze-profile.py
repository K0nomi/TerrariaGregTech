...
def health(counters):
    ...
    rows = [
        ...
        ("engine", "alloc_mb_per_sec", "alloc MB/s (process)"),
        ("engine", "thread_alloc_mb_per_sec", "alloc MB/s (this thread)"),
        ("server.engine", "thread_alloc_mb_per_sec", "alloc MB/s (server thread)"),
